...
export function InspireFooter({lang}){
  ...
  return <footer className="inspire-site-footer"><p>© {new Date().getFullYear()} ART STUDIO INSPIRE</p><span>{footer.location}</span><nav><a href="/contact">{footer.contact}</a><a href="https://www.instagram.com/artstudio.inspire" target="_blank" rel="noreferrer">{footer.instagram}</a><a href="/questions">{footer.questions}</a></nav></footer>;
}
