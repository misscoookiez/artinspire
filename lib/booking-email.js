...
export async function sendCompletedClassPaymentConfirmation({ email, name, purchase, amountCents, locale = "en" }) {
  ...
  const copy = paymentCopy[emailLocale(locale)];
  return sendEmail({
    to: email,
